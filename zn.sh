...
# 调整 CPU 频率
sed -i '24s/0x4/0xf/' target/linux/qualcommax/patches-6.6/0151-arm64-dts-qcom-ipq6018-add-1.2GHz-CPU-Frequency.patch
...
# 配置上海交通大学软件源
sed -i 's/downloads.openwrt.org/mirror.sjtu.edu.cn\/openwrt/g' include/version.mk
