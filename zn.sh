...
# 调整 CPU 频率
sed -i '27s/0x4/0xf/' target/linux/qualcommax/patches-6.12/0037-v6.16-arm64-dts-qcom-ipq6018-add-1.2GHz-CPU-Frequency.patch
sed -i '27s/0x2/0xf/' target/linux/qualcommax/patches-6.12/0038-v6.16-arm64-dts-qcom-ipq6018-add-1.5GHz-CPU-Frequency.patch
