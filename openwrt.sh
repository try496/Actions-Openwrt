...
# nikki
git clone https://github.com/nikkinikki-org/OpenWrt-nikki.git package/apps/OpenWrt-nikki
...
# openclash
git clone --single-branch --depth 1 -b master https://github.com/vernesong/OpenClash.git package/apps/openclash
...
sed -i 's|admin/services|admin/vpn|g' package/apps/homeproxy/root/usr/share/luci/menu.d/luci-app-homeproxy.json
